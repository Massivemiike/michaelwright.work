...
const INTERNAL_LINKS: NavLink[] = [
  ...
  { href: "/resume", label: "Resume" },
  {
    ...
    children: [
      ...
      { href: "/projects/sieve", label: "Sieve for Android", hint: "Android downloader + transcoder" },
      { href: "/projects/sieve-windows", label: "Sieve for Windows", hint: "Desktop downloader + transcoder" },
